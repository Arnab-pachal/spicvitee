...
const VideoGallery = ({isLoggedIn}) => {
  ...
  const handleUpload = async (event) => {
    ...
    try {
      const response = await fetch("https://spicmacayback.vercel.app/gallery/videoupload", {
        method: "POST",
        body: formData,
        urlencoded: true,
      });
  ...
  const fetchVideos = async () => {
    try {
      const response = await axios.get("https://spicmacayback.vercel.app/gallery/videoget");
  ...
  const handleDelete = async (id) => {
    ...
    if (value == null) {
      ...
      try {
        await axios.delete(`https://spicmacayback.vercel.app/gallery/videodelete?id=${id}`);
